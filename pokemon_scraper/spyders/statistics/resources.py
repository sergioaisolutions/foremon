...
defense_css_selector = '#main > div.section.poke-select-container.single > div:nth-child(1) > div.poke-stats > div.stat-container.defense.clear > div.stat-label > span.label-name'